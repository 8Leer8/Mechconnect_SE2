...
urlpatterns = [
    ...
    path('mechanic/my-addons/', views.list_my_service_addons, name='list_my_service_addons'),
    path('mechanic/my-addons/add/', views.add_my_service_addon, name='add_my_service_addon'),
    path('mechanic/my-addons/remove/', views.remove_my_service_addon, name='remove_my_service_addon'),

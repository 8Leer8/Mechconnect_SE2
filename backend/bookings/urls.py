...
urlpatterns = [
    ...
    path('mechanic/cash-remittances/', views.list_mechanic_cash_remittances, name='list-mechanic-cash-remittances'),
    ...
    path('mechanic/requests/<int:request_id>/accept-custom/', views.mechanic_accept_custom_request, name='mechanic-accept-custom-request'),
    path('mechanic/requests/<int:request_id>/decline-custom/', views.mechanic_decline_custom_request, name='mechanic-decline-custom-request'),

...
interface BottomNavProps {
  ...
  onTabPress: (tab: 'home' | 'bookings' | 'earnings' | 'profile') => void;
}

export function MechanicBottomNav({ activeTab, onTabPress }: BottomNavProps) {
  ...
  const tabs = [
    ...
    { name: 'earnings', label: 'Earnings', icon: 'dollarsign.circle.fill' },

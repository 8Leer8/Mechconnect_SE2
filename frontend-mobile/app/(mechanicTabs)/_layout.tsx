...
export default function MechanicTabLayout() {
  ...
  /** Latest booking id for the open success modal (avoids stale closure on "View booking"). */
  ...
  React.useEffect(() => {
    ...
    // Only treat explicit finalize events (avoids random booking_update + status accepted).
